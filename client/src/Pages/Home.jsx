  ...
  return (
    <div className="hmart-theme">
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="row g-2 align-items-center">
                  ...
                  <div className="col-md-3">
                    <button type="submit" className="btn btn-primary btn-lg w-100 rounded-pill fw-bold shadow-sm py-3" style={{ backgroundColor: '#00AEEF', borderColor: '#00AEEF' }}>
                      SEARCH
                    </button>
                  </div>
                </div>
              ...
              <div className="mt-3 d-flex flex-wrap gap-2 justify-content-center">
                ...
                {['Smartphones', 'Groceries', 'Hampers', 'Watches'].map(tag => (
                   <span 
                    ...
                    onClick={() => { setSearchTerm(tag); setPage(1); setSelectedCategory('All'); }}
                   >
                    {tag}
                   </span>
                ))}
      ...
      <div className="container">
        ...
        {/* 3. Products Header */}
        <div className="text-center mb-5" id="products-grid">
