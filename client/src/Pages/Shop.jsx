            ...
            <div className="card border-0 shadow-sm p-4 rounded-0 position-sticky" style={{ top: '100px' }}>
              ...
              <div className="category-list">
                {categories.map((cat) => (
                  <div 
                    key={cat}
                    className={`category-item py-2 px-3 mb-1 cursor-pointer transition-all ${activeCategory === cat ? 'bg-navy text-white fw-bold' : 'text-muted'}`}
                  ...
                  <div className="col-md-4 col-sm-6" key={p._id}>
                    <div className="card hmart-card h-100 rounded-0 border-0 shadow-sm transition-hover">
                      ...
                      <div className="card-body text-center d-flex flex-column justify-content-between">
                        ...
                        <button className="btn btn-sky w-100 fw-bold rounded-0 py-2 border-0" style={{ backgroundColor: '#00AEEF', color: 'white', fontSize: '13px' }}>
                          ADD TO CART
                        </button>
                      </div>
                    </div>
